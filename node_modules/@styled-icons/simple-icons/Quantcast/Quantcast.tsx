...
export const Quantcast: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const QuantcastDimensions = {height: 24, width: 24}
