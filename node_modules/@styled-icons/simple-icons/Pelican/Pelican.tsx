...
export const Pelican: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const PelicanDimensions = {height: 24, width: 24}
