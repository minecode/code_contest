...
export const FiveHundredPx: StyledIcon = React.forwardRef<SVGSVGElement, StyledIconProps>((props, ref) => {
...
export const FiveHundredPxDimensions = {height: 24, width: 24}
